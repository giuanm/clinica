                    ...
                    <div className="w-1/3 mx-auto" style={{ scrollSnapType: 'x mandatory' }}>
                        {carouselItems.map((item, index) => (
                            <div key={index} style={{ display: currentSlide === index ? 'block' : 'none' }}>
                                ...
                                <div className="w-full bg-white rounded-lg shadow-lg transition-all duration-100 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                                    ...
                                    <div className="absolute top-1/2 w-1/3 flex justify-between">
                                        <label onClick={handlePrevSlide} className="inline-block text-red-600 cursor-pointer -translate-x bg-white rounded-full shadow-md active:translate-y-0.1">
                                            &lt;
                                        </label>
                                        <label onClick={handleNextSlide} className="relative text-red-600 cursor-pointer -translate-x bg-white rounded-full shadow-md active:translate-y-0.1">
                                            &gt;
                                        </label>
                                    </div>
                                </div>
